...
describe Dessert do
  ...
  describe "#add_ingredient" do
    it "adds an ingredient to the ingredients array" do 
      ...
      expect(dessert.ingredients).to eq(['batter'])
    end
  end
  ...
  describe "#serve" do
    let(:chef) {double('Jeff', :titleize => "Chef Jeff the Great Baker")}
    it "contains the titleized version of the chef's name" do
      expect(dessert.serve).to include('Chef Jeff the Great Baker')
    end
  end
